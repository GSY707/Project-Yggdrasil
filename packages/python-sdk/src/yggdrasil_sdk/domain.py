...
class AgentRunRecord(BaseModel):
    ...
    run_type: Literal["main", "subagent", "fork", "maintenance", "evaluation"] = Field(alias="runType")
    fork_root_run_id: str | None = Field(default=None, alias="forkRootRunId")
    fork_depth: int = Field(default=0, alias="forkDepth")
    assigned_work_tree_node_id: str | None = Field(default=None, alias="assignedWorkTreeNodeId")
    parent_context_anchor: str | None = Field(default=None, alias="parentContextAnchor")
    fork_group_id: str | None = Field(default=None, alias="forkGroupId")
