...
def _builtin_server_definitions(workspace_root: Path | None = None) -> list[dict[str, Any]]:
    ...
    return [
        ...
        {
            "id": "workspace-web",
            "displayName": "Workspace Web MCP",
            "description": "Builtin MCP server for public web search and webpage retrieval.",
            "transport": "stdio",
            "command": python_executable,
            "args": ["-m", "yggdrasil_sdk.mcp_servers.web_server"],
            "enabled": True,
            "keepAlive": True,
            "toolPrefix": "web",
            "origin": "builtin",
            "sourcePath": "yggdrasil_sdk.mcp_servers.web_server",
            "timeoutMs": 20000,
        },
        {
            "id": "workspace-paper",
            "displayName": "Workspace Paper MCP",
            "description": "Builtin MCP server for scholarly paper search across major public APIs.",
            "transport": "stdio",
            "command": python_executable,
            "args": ["-m", "yggdrasil_sdk.mcp_servers.paper_server"],
            "enabled": True,
            "keepAlive": True,
            "toolPrefix": "paper",
            "origin": "builtin",
            "sourcePath": "yggdrasil_sdk.mcp_servers.paper_server",
            "timeoutMs": 20000,
        },
        {
            "id": "workspace-markitdown",
            "displayName": "Workspace MarkItDown MCP",
            "description": "Builtin MCP server for URL/file to markdown conversion with markitdown fallback.",
            "transport": "stdio",
            "command": python_executable,
            "args": ["-m", "yggdrasil_sdk.mcp_servers.markitdown_server"],
            "enabled": True,
            "keepAlive": True,
            "toolPrefix": "markitdown_local",
            "origin": "builtin",
            "sourcePath": "yggdrasil_sdk.mcp_servers.markitdown_server",
            "timeoutMs": 20000,
        },
        {
            "id": "workspace-report",
            "displayName": "Workspace Report MCP",
            "description": "Builtin MCP server for reporting project/runtime/tool issues.",
            "transport": "stdio",
            "command": python_executable,
            "args": ["-m", "yggdrasil_sdk.mcp_servers.report_server"],
            "enabled": True,
            "keepAlive": True,
            "toolPrefix": "report",
            "origin": "builtin",
            "sourcePath": "yggdrasil_sdk.mcp_servers.report_server",
            "timeoutMs": 10000,
        },
    ]
