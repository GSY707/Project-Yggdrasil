def invoke_runtime_completion(
    ...
    *,
    ...
    window_execution_metadata = _window_execution_metadata_summary(
        request,
        root_mount,
        current_context,
        resume_path=resume_path,
    ...
    langfuse_metadata = {
        ...
        "windowExecution": window_execution_metadata,
    }
    try:
        with observe_span(
            service_name,
            ...
            finish_langfuse_generation(
                ...
                metadata={
                    **langfuse_metadata,
                    ...
                    "windowExecution": _window_execution_metadata_summary(
                        request,
                        root_mount,
                        current_context,
                        resume_path=resume_path,
