...
class AssetRepository:
    ...
    def create_asset(self, payload: dict[str, Any]) -> AssetRecord:
        record = AssetRecord(
            ...
            relatedWorkTreeNodeIds=[str(node_id) for node_id in payload.get("relatedWorkTreeNodeIds") or []],
        ...
        model = AssetORM(
            ...
            related_work_tree_node_ids=list(record.related_work_tree_node_ids),
