...
class AgentRunORM(Base):
    ...
    fork_root_run_id: Mapped[str | None] = mapped_column(sa.String(128), nullable=True, index=True)
    fork_depth: Mapped[int] = mapped_column(sa.Integer(), nullable=False, default=0)
    assigned_work_tree_node_id: Mapped[str | None] = mapped_column(sa.String(128), nullable=True, index=True)
    parent_context_anchor: Mapped[str | None] = mapped_column(sa.String(255), nullable=True)
    fork_group_id: Mapped[str | None] = mapped_column(sa.String(128), nullable=True, index=True)
