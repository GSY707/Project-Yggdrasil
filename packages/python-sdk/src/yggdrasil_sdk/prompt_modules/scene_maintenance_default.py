...
class MaintenanceDefaultSceneModule(BaseModulePlugin):
    module_id = "scene-maintenance-default"
    ...
    def enable_preflight(self, payload: dict[str, object]) -> dict[str, object]:
        return {"status": "ok", "summary": "Maintenance default scene module preflight passed."}

    def report_health(self, payload: dict[str, object]) -> dict[str, object]:
        return {"status": "healthy", "summary": "Maintenance default scene module is ready."}

    def register_seed_templates(self, payload: dict[str, object]) -> dict[str, object]:
        return {
            "seedTemplates": [load_module_prompt_asset(self.module_id, "scenes/maintenance-default.yaml")],
            "moduleId": self.module_id,
        }


plugin = MaintenanceDefaultSceneModule()