...
class CodingInheritProjectSceneModule(BaseModulePlugin):
    module_id = "scene-coding-inherit-project"
    ...
    def enable_preflight(self, payload: dict[str, object]) -> dict[str, object]:
        return {"status": "ok", "summary": "Coding inherit-project scene module preflight passed."}

    def report_health(self, payload: dict[str, object]) -> dict[str, object]:
        return {"status": "healthy", "summary": "Coding inherit-project scene module is ready."}

    def register_seed_templates(self, payload: dict[str, object]) -> dict[str, object]:
        return {
            "seedTemplates": [load_module_prompt_asset(self.module_id, "scenes/coding-inherit-project.yaml")],
            "moduleId": self.module_id,
        }


plugin = CodingInheritProjectSceneModule()