...
class LearningCoachSceneModule(BaseModulePlugin):
    module_id = "scene-learning-coach"
    ...
    def enable_preflight(self, payload: dict[str, object]) -> dict[str, object]:
        return {"status": "ok", "summary": "Learning coach scene module preflight passed."}

    def report_health(self, payload: dict[str, object]) -> dict[str, object]:
        return {"status": "healthy", "summary": "Learning coach scene module is ready."}

    def register_seed_templates(self, payload: dict[str, object]) -> dict[str, object]:
        return {
            "seedTemplates": [load_module_prompt_asset(self.module_id, "scenes/learning-coach.yaml")],
            "moduleId": self.module_id,
        }


plugin = LearningCoachSceneModule()