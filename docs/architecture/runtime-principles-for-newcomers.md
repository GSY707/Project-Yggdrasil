...
> 本文是面向新人的下层解释。项目设计哲学唯一主文档为[世界树计划完整设计哲学](design-philosophy-and-cognitive-principles.md)；若两者冲突，以主文档为准。
...
子节点的价值不是“让流程更像计划”，而是让父节点保持干净。子节点回到父节点时，带回父节点真正需要的有用信息：
...
完整搜索过程、完整日志、未采用草稿和失败命令流水账不应回灌父节点；下一步由父节点重新审视任务后决定。
